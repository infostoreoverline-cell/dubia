...
static constexpr uint8_t  PIN_SCL           = 12;    // D6 — SCL su scheda AITEXM ESP8266+OLED
...
static constexpr uint64_t SLEEP_US          = 60ULL * 1000000ULL;
static constexpr uint32_t READINGS_PER_SEND = 60;
...
void setup() {
  ...
  DBG_PRINTLN(F("[BOOT] → deepSleep 60s"));
  ESP.deepSleep(SLEEP_US, WAKE_RF_DISABLED);
}
